...
def parse_args():
    ...
    parser.add_argument('--arch', type=str, choices=['resnet18', 'wide_resnet50_2', 'resnet50','swinv2_b','conformer_b_16_cnn','conformer_b_16_vit','vit_b_16','clip_b_16'], default='resnet18')
